/**
 * Putting user defined class(as key) and HashMap(value) in TreeMap
 * Comparing the key using Comparator interface.
 */

import java.util.*;

/**
 * Key in TreeMap must be Comparable or Comparator should be provided in constructor of TreeMap explicitly.
 * Writing a class to implement Comparator interface. This class compares wars on their years.
 * @author Abhijeet Rai
 */
class SortByYear implements Comparator<War> {

        /**
         * Overriding compare method of Comparatorinterface to
         * sort Wars according to year
         * @param War
         * @param War
         * @return Integer value depending upon comparison of years
         */
        public int compare(War w1, War w2) {
 ...
 /**
  * Class war that holds the year of the war. It acts as key in TreeMap
  * @author Abhijeet Rai
  */
  class War {
  ...
  class Demo {
          ...
          public static void main(String[] args) {
                   ...
                   */
                  TreeMap<War,HashMap> wars = new TreeMap<War,HashMap> (new SortByYear());
